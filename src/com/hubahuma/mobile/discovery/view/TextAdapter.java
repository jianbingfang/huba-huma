...
public class TextAdapter extends ArrayAdapter<String> {
	...
	public TextAdapter(Context context, List<String> listData, int selectedColor, int unselectedColor) {
		super(context, R.string.no_data, listData);
		mContext = context;
		mListData = listData;
		selectedBgColor = mContext.getResources().getColor(selectedColor);
		unselectedBgColor = mContext.getResources().getColor(unselectedColor);
		init();
	}

	public TextAdapter(Context context, String[] arrayData, int selectedColor, int unselectedColor) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			view = (TextView) LayoutInflater.from(mContext).inflate(
					R.layout.expendtab_choose_item, parent, false);
		} else {
		...
		if (selectedText != null && selectedText.equals(mString)) {
			...
			view.setBackgroundColor(unselectedBgColor);// 设置未选中状态背景图片
		}
