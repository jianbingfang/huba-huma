...
import com.hubahuma.mobile.discovery.SearchTeacherActivity_;
...
@NoTitle
@EActivity(R.layout.activity_parent_main)
public class ParentMainActivity extends TabActivity {
	...
	void init() {
		...
		intent = new Intent().setClass(this, SearchTeacherActivity_.class);
	...
	private void exitApp() {
		...
		if ((System.currentTimeMillis() - exitTime) > 2000) {
			Toast.makeText(ParentMainActivity.this, "再按一次退出程序",
