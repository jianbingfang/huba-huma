...
public class SimpleManageBookListViewGesture implements View.OnTouchListener {
	...
	public SimpleManageBookListViewGesture(ExpandableListView listView,
	...
	private void GetResourcesValues() {
		...
		FullTextFinal = activity.getResources()
